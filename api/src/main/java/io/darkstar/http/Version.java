...
import io.darkstar.lang.Charsets;
...
public class Version implements Comparable<Version> {
    ...
    /**
     * Returns an existing or new {@link Version} instance which matches to
     ...
     * will be returned.  Otherwise, a new {@link Version} instance will be
     * returned.
     */
    public static Version valueOf(String text) {
        ...
        //
        Version version = version0(text);
        if (version == null) {
            version = new Version(text, true);
        }
        return version;
    }

    private static Version version0(String text) {
     ...
     */
    public Version(String text, boolean keepAliveDefault) {
        if (text == null) {
            throw new NullPointerException("text");
        }
        ...
        this.byteValue = this.text.getBytes(Charsets.US_ASCII);
    }
     ...
     *                         the {@code "Connection"} header is set to {@code "close"} explicitly.
     */
    private Version(String protocolName, int majorVersion, int minorVersion, boolean keepAliveDefault) {
